...
static constexpr auto qt_meta_stringdata_ZN12FileTransferE = QtMocHelpers::stringData(
    "FileTransfer",
    "refreshFileList",
    "",
    "uploadFile",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12FileTransferE[] = {
...
Q_CONSTINIT const QMetaObject FileTransfer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12FileTransferE.offsetsAndSizes,
    qt_meta_data_ZN12FileTransferE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12FileTransferE_t,
        // Q_OBJECT / Q_GADGET
...
void FileTransfer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->handleFileList((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 4: _t->displayStatus((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *FileTransfer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12FileTransferE.stringdata0))
